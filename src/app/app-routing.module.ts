...
const routes: Routes = [
  ...
  {path:'detailCycleAdmin', component:DetailCycleTontineComponent , canActivate:[adminGuardGuard]},
  ...
  {path:'cycleTontine/:idUser/cycles/:idTontine', component:ListeCycleTontineComponent , canActivate:[adminGuardGuard]},
